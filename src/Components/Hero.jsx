...
const Hero = () => {
  ...
  return (
    <div
      className={`w-full flex flex-col-reverse md:flex-row relative top-20 md:top-32 gap-3 pb-8  ${
        darkMode
    ...
    >
      <div
        className={`flex flex-col justify-center items-center md:block px-4 md:px-32 md:py-20 font-open-sans w-full md:w-[60%] ${
      ...
      >
        ...
        <h1 className="text-5xl mb-2  md:text-6xl mt-2 font-semibold">
          Ahmed{" "}
          <span className={darkMode ? "text-dark-secondary" : "text-secondary"}>
            Arhab
          </span>
        ...
        <div
          className={`btns mt-5 flex-col flex justify-center items-center md:block ${
            darkMode ? "text-dark-primary" : "text-primary"
          }`}
        >
          <a
          ...
          <a
            className={`flex justify-center items-center py-1 px-2 border rounded-md w-fit focus:border-dark-secondary hover:border-dark-secondary transition-all duration-150 ease-linear my-3 ${
              darkMode ? "border-dark-primary" : "border-primary"
            }`}
        ...
        <div className="social-icon mt-5 flex items-center justify-between gap-4 w-fit">
          <a
            ...
            className={`flex justify-center items-center p-2 border rounded-full w-fit transition-all duration-150 ease-linear ${
              darkMode
                ? darkMode
