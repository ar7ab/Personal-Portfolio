...
const Contact = () => {
  ...
  return (
    ...
    >
      <Navbar />
      <div
        className={`resume grid grid-cols-1 md:grid-cols-2 justify-center gap-5 px-6 md:px-48 relative py-8 top-12 md:top-32 font-open-sans w-full ${
          darkMode
            ? "bg-dark-background text-dark-primary"
            : "bg-background text-black"
        }`}
      >
        ...
        <div
          className={`form p-4 md:p-7 ${
            darkMode ? "bg-[#1E1C21] " : "bg-[#F6F0F9] "
          } rounded-xl`}
        >
